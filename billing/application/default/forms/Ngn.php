 ...
 * Ngn.php
 *
 * This file contians form for edit or add page for NGN service
 *
 * @author marat
 */

/*
 * Requires Zend Form to extending from
 */
require_once('Zend/Form.php');

require_once('forms/elements/NgnNumbers.php');
require_once('GenerateData.php');

class Form_Ngn extends Zend_Form
{
    public function init()
    {
        ...
        //оплата за телефон
        $phonePayElement = new Zend_Form_Element_Select('phone_pay');
        $phonePayElement->setLabel('Оплата за телефон:')
            ->addDecorator('Separator')
            ->addMultiOptions(array(120    => '120', 140 => '140'));
        $this->addElement($phonePayElement);

        //NGN номера
        $ngnNumbersElement = new Form_Element_NgnNumbers('numbers');
