...
class Form_Hosting extends Zend_Form
{
    public function init()
    {
        ...
        $penable_status->addDecorator('Separator')
                       ->setLabel('Вступило в силу:');
        ...
        // коменты к скидке
        $adsl_discountcomment = new Zend_Form_Element_Text('discountcomment');
        ...
        // Доменное имя:
        $domain_addres = new Zend_Form_Element_Text('domain_addres');
        $domain_addres->setLabel('Доменное имя:  ')
                             ->setAttrib('id', 'some_id')
                             ->addDecorator('Separator');
        $this->addElement($domain_addres);
