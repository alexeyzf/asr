...
require_once('forms/elements/TradtelNumbers.php');

class Form_Tradtel extends Zend_Form
{
    public function init()
    {
        ...
        $penableElement = new Zend_Form_Element_Checkbox('penable');
        $penableElement->setLabel('Вступило в силу:')
                       ->addDecorator('Separator');
        $this->addElement($penableElement);
		
        //абонентская 
        $abonPriceElement =  new Zend_Form_Element_Text('abon_price');
        $abonPriceElement->setLabel('Абонентская плата:')
        				->addDecorator('Separator');
        $this->addElement($abonPriceElement);
        ...
        /*// Номер прямого провода
        $directline_number = new Zend_Form_Element_Text('directline_number');
        $directline_number->setLabel('Номер прямого провода:*')
                        ->addDecorator('Separator');
        $this->addElement($directline_number);*/

        // Номера
        $ngnNumbersElement = new Form_Element_TradtelNumbers('numbers');
