<?php
/**
 * Form for showing on client recalculation history page
 *
 * @author marat
 */
...
class Form_Reportdateform extends Zend_Form
{
	public function init()
 	{
        ...
        $chbox = new Zend_Form_Element_Checkbox('is_stream');
        $chbox->setLabel('стрим/корп:')
              ->removeDecorator('Errors')
	          ->removeDecorator('Description')
	          ->removeDecorator('HtmlTag')
	          ->removeDecorator('Label')
        ...
        $searchButton = new Zend_Form_Element_Submit('search', 'Поиск');
