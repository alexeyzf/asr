...
class TwoLettresRtf extends RtfHelper
{
    ...
    public function generate($letterNumber, $letterNumber_new, $phoneHubInfo, $pointInfo, $isInsteadLostLetter = false, $oldDataPoint)
    {
        $this->_content = $this->getTemplate('2letters');
